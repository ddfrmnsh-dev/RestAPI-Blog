...
export class BillCodeError extends RequestError {

    "AMOUNT": string;
    "CUST NAME": string;
    "SUBCOMPANY CODE": string;
    "CURRENCY CODE": string;

    constructor(message: string, code: string = "BAD_REQUEST", additionalInfo:any) {
        super(message, 400, code);
        this.AMOUNT = additionalInfo.AMOUNT
        this["CUST NAME"] = additionalInfo["CUST NAME"]
        this["SUBCOMPANY CODE"] = additionalInfo["SUBCOMPANY CODE"]
        this["CURRENCY CODE"] = additionalInfo["CURRENCY CODE"]
    }
